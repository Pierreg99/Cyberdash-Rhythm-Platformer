...
export class MenuManager {
    constructor(game) {
        this.game = game;
        this.currentTab = 'levels'; // 'levels', 'store', 'garage', 'pass', 'editor', 'databank', 'settings'
    ...
    updateGaragePreview() {
        ...
        if (typeLabel) typeLabel.innerText = `${activeChar.type} // ${activeChar.rarity}`;
