/**
 * CYBER DASH // EXPANDED 12-SECTOR UNIVERSE (EASY, HARD & OMEGA TIERS)
 * Handcrafted, rhythmic, fair, and fully configurable tracks with procedural synthesis.
 */
...
export const LEVELS = [
    // =========================================================================
    // TIER 1: EASY SECTORS (Entry, Rhythm & Flow / 1-2★)
    // =========================================================================
    {
        id: 1,
        tier: "EASY",
    ...
    // =========================================================================
    // TIER 2: HARD SECTORS (Velocity, Precision & Modifiers / 3-4★)
    // =========================================================================
    {
        id: 5,
        tier: "HARD",
    ...
    // =========================================================================
    // TIER 3: OMEGA SECTORS (Demon & Extreme Mastery / 5-7★)
    // =========================================================================
    {
        id: 9,
        tier: "OMEGA",
    ...
    // =========================================================================
    // TIER 4: CRYO SECTORS (Ice & Freeze Mechanics / Special Challenge)
    // =========================================================================
    {
        id: 13,
        tier: "CRYO",
        name: "CRYO GENESIS",
        subtitle: "The First Frost",
        desc: "Learn the freeze orb and glide across slippery ice blocks in sub-zero corridors.",
        diff: "EASY",
        stars: 2,
        length: 250,
        color: "#a8eeff",
        bg: "#020812",
        forms: ["CUBE", "SHIP"],
        audioTrack: { bpm: 126, rootFreq: 32.70, scale: "AEOLIAN" },
        data: [
            [8, 0, OBJECT_TYPES.ICE_BLOCK], [9, 0, OBJECT_TYPES.ICE_BLOCK], [10, 0, OBJECT_TYPES.ICE_BLOCK],
            [14, 0, OBJECT_TYPES.ICE_SPIKE],
            [18, 0, OBJECT_TYPES.ICE_BLOCK], [19, 0, OBJECT_TYPES.ICE_BLOCK],
            [22, 3, OBJECT_TYPES.ORB_FREEZE],
            [26, 0, OBJECT_TYPES.ICE_BLOCK], [27, 1, OBJECT_TYPES.ICE_BLOCK],
            [32, 3, OBJECT_TYPES.ICE_CRYSTAL, 0],
            [36, 0, OBJECT_TYPES.PAD_ICE],
            [41, 3, OBJECT_TYPES.ORB_FREEZE],
            [46, 0, OBJECT_TYPES.ICE_BLOCK], [47, 0, OBJECT_TYPES.ICE_BLOCK],
            [52, 0, OBJECT_TYPES.PORTAL_SHIP],
            [58, 2, OBJECT_TYPES.ICE_BLOCK], [62, 5, OBJECT_TYPES.ICE_BLOCK],
            [67, 1, OBJECT_TYPES.ICE_BLOCK], [72, 4, OBJECT_TYPES.ICE_BLOCK],
            [76, 5, OBJECT_TYPES.ICE_CRYSTAL, 1],
            [80, 2, OBJECT_TYPES.ICE_BLOCK],
            [88, 0, OBJECT_TYPES.PORTAL_CUBE],
            [94, 0, OBJECT_TYPES.ICE_SPIKE],
            [98, 0, OBJECT_TYPES.PAD_ICE], [103, 3, OBJECT_TYPES.ORB_FREEZE],
            [108, 0, OBJECT_TYPES.ICE_BLOCK], [109, 1, OBJECT_TYPES.ICE_BLOCK],
            [114, 0, OBJECT_TYPES.ICE_SPIKE], [115, 0, OBJECT_TYPES.ICE_SPIKE],
            [120, 0, OBJECT_TYPES.PAD_YELLOW], [125, 4, OBJECT_TYPES.ORB_YELLOW],
            [129, 3, OBJECT_TYPES.ICE_CRYSTAL, 2],
            [134, 0, OBJECT_TYPES.ICE_BLOCK], [135, 0, OBJECT_TYPES.ICE_BLOCK],
            [140, 0, OBJECT_TYPES.ICE_SPIKE], [145, 0, OBJECT_TYPES.PAD_ICE],
            [152, 0, OBJECT_TYPES.ICE_BLOCK], [153, 1, OBJECT_TYPES.ICE_BLOCK], [154, 2, OBJECT_TYPES.ICE_BLOCK]
        ]
    },
    {
        id: 14,
        ...
        bg: "#010a10",
        forms: ["CUBE", "UFO", "WAVE"],
        audioTrack: { bpm: 132, rootFreq: 34.65, scale: "DORIAN" },
        data: [
            [8, 0, OBJECT_TYPES.ICE_BLOCK], [9, 0, OBJECT_TYPES.ICE_BLOCK],
            [13, 0, OBJECT_TYPES.PAD_ICE], [18, 3, OBJECT_TYPES.ORB_FREEZE],
            [22, 0, OBJECT_TYPES.ICE_BLOCK], [23, 1, OBJECT_TYPES.ICE_BLOCK],
            [28, 0, OBJECT_TYPES.ICE_SPIKE],
            [32, 0, OBJECT_TYPES.FREEZE_ZONE],
            [36, 4, OBJECT_TYPES.ICE_CRYSTAL, 0],
            [40, 0, OBJECT_TYPES.PORTAL_UFO],
            [46, 2, OBJECT_TYPES.SAWBLADE], [52, 5, OBJECT_TYPES.SAWBLADE],
            [58, 2, OBJECT_TYPES.ICE_BLOCK], [64, 4, OBJECT_TYPES.ICE_CRYSTAL, 1],
            [70, 3, OBJECT_TYPES.SAWBLADE],
            [78, 0, OBJECT_TYPES.PORTAL_CUBE],
            [84, 0, OBJECT_TYPES.PAD_ICE], [89, 3, OBJECT_TYPES.ORB_FREEZE],
            [94, 0, OBJECT_TYPES.ICE_BLOCK], [95, 1, OBJECT_TYPES.ICE_BLOCK],
            [100, 0, OBJECT_TYPES.FREEZE_ZONE],
            [106, 0, OBJECT_TYPES.PORTAL_WAVE],
            [112, 2, OBJECT_TYPES.ICE_BLOCK], [112, 6, OBJECT_TYPES.ICE_BLOCK],
            [118, 1, OBJECT_TYPES.ICE_BLOCK], [118, 5, OBJECT_TYPES.ICE_BLOCK],
            [124, 3, OBJECT_TYPES.ICE_CRYSTAL, 2],
            [130, 0, OBJECT_TYPES.PORTAL_CUBE],
            [136, 0, OBJECT_TYPES.PAD_YELLOW], [142, 4, OBJECT_TYPES.ORB_YELLOW],
            [148, 0, OBJECT_TYPES.ICE_BLOCK], [149, 1, OBJECT_TYPES.ICE_BLOCK], [150, 2, OBJECT_TYPES.ICE_BLOCK]
        ]
    },
    {
        id: 15,
        ...
        color: "#00d4ff",
        bg: "#010810",
        forms: ["CUBE", "WAVE", "BALL"],
        audioTrack: { bpm: 148, rootFreq: 38.89, scale: "HARMONIC_MIN" },
        data: [
            [8, 0, OBJECT_TYPES.ICE_SPIKE], [12, 0, OBJECT_TYPES.PAD_ICE],
            [17, 3, OBJECT_TYPES.ORB_FREEZE], [22, 0, OBJECT_TYPES.ICE_BLOCK], [23, 1, OBJECT_TYPES.ICE_BLOCK],
            [28, 0, OBJECT_TYPES.PORTAL_WAVE],
            [34, 2, OBJECT_TYPES.ICE_BLOCK], [34, 6, OBJECT_TYPES.ICE_BLOCK],
            [40, 1, OBJECT_TYPES.ICE_BLOCK], [40, 5, OBJECT_TYPES.ICE_BLOCK],
            [46, 3, OBJECT_TYPES.ICE_CRYSTAL, 0],
            [52, 2, OBJECT_TYPES.SAWBLADE], [52, 6, OBJECT_TYPES.SAWBLADE],
            [58, 0, OBJECT_TYPES.PORTAL_BALL],
            [64, 0, OBJECT_TYPES.ICE_SPIKE], [67, 3, OBJECT_TYPES.ICE_BLOCK],
            [71, 0, OBJECT_TYPES.ICE_SPIKE], [75, 4, OBJECT_TYPES.ICE_BLOCK],
            [82, 0, OBJECT_TYPES.PORTAL_CUBE],
            [88, 0, OBJECT_TYPES.FREEZE_ZONE],
            [94, 0, OBJECT_TYPES.PAD_ICE], [99, 3, OBJECT_TYPES.ORB_FREEZE],
            [104, 3, OBJECT_TYPES.ICE_CRYSTAL, 1],
            [110, 0, OBJECT_TYPES.PORTAL_WAVE],
            [116, 2, OBJECT_TYPES.ICE_BLOCK], [116, 5, OBJECT_TYPES.SAWBLADE],
            [122, 1, OBJECT_TYPES.SAWBLADE], [128, 4, OBJECT_TYPES.ICE_CRYSTAL, 2],
            [134, 0, OBJECT_TYPES.PORTAL_CUBE],
            [140, 0, OBJECT_TYPES.PAD_RED], [146, 5, OBJECT_TYPES.ORB_RED],
            [152, 0, OBJECT_TYPES.ICE_BLOCK], [153, 1, OBJECT_TYPES.ICE_BLOCK], [154, 2, OBJECT_TYPES.ICE_BLOCK]
        ]
    },
    {
        ...
        bg: "#000508",
        forms: ["CUBE", "SHIP", "UFO", "WAVE", "BALL", "ROBOT"],
        audioTrack: { bpm: 165, rootFreq: 32.70, scale: "HARMONIC_MIN" },
        data: [
            [8, 0, OBJECT_TYPES.ICE_SPIKE], [10, 0, OBJECT_TYPES.PAD_ICE],
            [16, 5, OBJECT_TYPES.ORB_FREEZE], [21, 3, OBJECT_TYPES.ORB_BLUE_GRAV],
            [26, 4, OBJECT_TYPES.ICE_CRYSTAL, 0],
            [32, 0, OBJECT_TYPES.SPEED_2X], [34, 0, OBJECT_TYPES.PORTAL_WAVE],
            [39, 2, OBJECT_TYPES.ICE_BLOCK], [39, 5, OBJECT_TYPES.ICE_BLOCK],
            [45, 1, OBJECT_TYPES.SAWBLADE], [50, 4, OBJECT_TYPES.SAWBLADE],
            [56, 3, OBJECT_TYPES.FREEZE_ZONE],
            [62, 0, OBJECT_TYPES.PORTAL_BALL],
            [67, 0, OBJECT_TYPES.ICE_SPIKE], [70, 3, OBJECT_TYPES.ICE_BLOCK],
            [74, 0, OBJECT_TYPES.ICE_SPIKE], [78, 4, OBJECT_TYPES.ICE_BLOCK],
            [85, 0, OBJECT_TYPES.PORTAL_ROBOT],
            [91, 0, OBJECT_TYPES.ICE_SPIKE], [92, 0, OBJECT_TYPES.ICE_SPIKE],
            [97, 0, OBJECT_TYPES.ICE_BLOCK], [98, 1, OBJECT_TYPES.ICE_BLOCK],
            [104, 4, OBJECT_TYPES.ICE_CRYSTAL, 1],
            [111, 0, OBJECT_TYPES.PORTAL_SHIP],
            [117, 2, OBJECT_TYPES.SAWBLADE], [123, 5, OBJECT_TYPES.SAWBLADE],
            [129, 0, OBJECT_TYPES.FREEZE_ZONE],
            [135, 0, OBJECT_TYPES.SPEED_1X], [137, 0, OBJECT_TYPES.PORTAL_CUBE],
            [143, 0, OBJECT_TYPES.PAD_ICE], [150, 3, OBJECT_TYPES.ORB_FREEZE],
            [157, 3, OBJECT_TYPES.ICE_CRYSTAL, 2],
            [163, 0, OBJECT_TYPES.ICE_BLOCK], [164, 1, OBJECT_TYPES.ICE_BLOCK], [165, 2, OBJECT_TYPES.ICE_BLOCK], [166, 3, OBJECT_TYPES.ICE_BLOCK]
        ]
    }
];

/**
 * Draw Level Map Objects — Enhanced with full ice/freeze assets and improved graphics
 */
export function drawLevelMap(ctx, levelData, camX, groundY, levelColor = '#00f0ff') {
    ...
    for (let i = 0; i < levelData.length; i++) {
        ...
        if (type === OBJECT_TYPES.BLOCK) {
            const grad = ctx.createLinearGradient(ox, oy, ox, oy + TS);
            ...
            ctx.globalAlpha = 0.5;
            [[ox+4,oy+4],[ox+TS-4,oy+4],[ox+4,oy+TS-4],[ox+TS-4,oy+TS-4]].forEach(([rx,ry]) => {
        ...
        // ── SPIKE ─────────────────────────────────────────────────────────────
            ...
            const spikeGrad = ctx.createLinearGradient(ox + TS/2, oy, ox + TS/2, oy + TS);
            spikeGrad.addColorStop(0, '#ff003c');
            spikeGrad.addColorStop(1, '#880022');
            ...
            ctx.shadowColor = '#ff003c';
            ctx.beginPath();
            ctx.arc(ox + TS/2, oy + 3, 2, 0, Math.PI*2);
            ctx.fill();
        ...
        // ── SAWBLADE ──────────────────────────────────────────────────────────
            ...
            ctx.shadowBlur = 20;
            ctx.shadowColor = '#ff003c';
            const sawGrad = ctx.createRadialGradient(0, 0, r * 0.3, 0, 0, r);
            sawGrad.addColorStop(0, '#ff2244');
            sawGrad.addColorStop(1, '#cc0022');
            ctx.fillStyle = sawGrad;
            ctx.beginPath();
            const teeth = 10;
            for (let t = 0; t < teeth * 2; t++) {
                const angle = (t * Math.PI) / teeth;
                const radius = t % 2 === 0 ? r : r * 0.62;
        ...
        // ── JUMP PADS ─────────────────────────────────────────────────────────
            ...
            type === OBJECT_TYPES.PAD_YELLOW || type === OBJECT_TYPES.PAD_PINK ||
            type === OBJECT_TYPES.PAD_RED || type === OBJECT_TYPES.PAD_BLUE_GRAV
        ) {
            let padColor = '#ffd700';
            ...
            const bounce = Math.abs(Math.sin(now * 4)) * 3;
            ctx.shadowBlur = 16;
            ctx.shadowColor = padColor;
            ctx.fillStyle = padColor;
            ctx.fillRect(ox + 3, oy + TS - 10, TS - 6, 10);
            ctx.fillStyle = '#ffffff';
            ctx.globalAlpha = 0.9;
            ctx.beginPath();
            ctx.moveTo(ox + TS/2, oy + TS - 20 - bounce);
            ctx.lineTo(ox + TS/2 - 7, oy + TS - 12);
            ctx.lineTo(ox + TS/2 + 7, oy + TS - 12);
            ctx.closePath();
            ctx.fill();
            ctx.globalAlpha = 0.6;
            ctx.fillRect(ox + 8, oy + TS - 9, TS - 16, 2);
            ctx.globalAlpha = 1;

        // ── JUMP ORBS ─────────────────────────────────────────────────────────
        } else if (
            type === OBJECT_TYPES.ORB_YELLOW || type === OBJECT_TYPES.ORB_PINK ||
            type === OBJECT_TYPES.ORB_RED || type === OBJECT_TYPES.ORB_BLUE_GRAV ||
            type === OBJECT_TYPES.ORB_GREEN_GRAV || type === OBJECT_TYPES.ORB_BLACK_SLAM
        ) {
            let orbColor = '#ffd700';
            ...
            else if (type === OBJECT_TYPES.ORB_BLACK_SLAM) orbColor = '#6644aa';
            ...
            ctx.lineWidth = 2;
            ctx.globalAlpha = 0.4 + Math.sin(now * 3) * 0.2;
            ctx.beginPath();
            ctx.arc(ox + TS/2, oy + TS/2, orbR + 8, 0, Math.PI * 2);
            ctx.stroke();
            ctx.globalAlpha = 1;
            const orbGrad = ctx.createRadialGradient(ox + TS/2 - 4, oy + TS/2 - 4, 2, ox + TS/2, oy + TS/2, orbR);
            orbGrad.addColorStop(0, '#ffffff');
            orbGrad.addColorStop(0.3, orbColor);
            orbGrad.addColorStop(1, orbColor + '88');
            ctx.fillStyle = orbGrad;
            ctx.beginPath();
            ctx.arc(ox + TS/2, oy + TS/2, orbR, 0, Math.PI * 2);
            ctx.fill();
            ctx.fillStyle = 'rgba(255,255,255,0.35)';
            ctx.beginPath();
            ctx.arc(ox + TS/2 - 4, oy + TS/2 - 4, orbR * 0.35, 0, Math.PI * 2);
            ctx.fill();

        // ── PORTALS ───────────────────────────────────────────────────────────
        } else if (
            (type >= OBJECT_TYPES.PORTAL_SHIP && type <= OBJECT_TYPES.PORTAL_GRAV_INVERT) ||
            type === OBJECT_TYPES.PORTAL_MINI || type === OBJECT_TYPES.PORTAL_GROWTH
        ) {
            ...
            else if (type === OBJECT_TYPES.PORTAL_GRAV_INVERT) { portalColor = '#b026ff'; label = 'INV-G'; }
            ...
            const pAlpha = 0.3 + Math.sin(now * 2) * 0.15;
            const pH = TS * 2.5;
            const pX = ox + TS * 0.15;
            const pY = oy - TS * 1.5;
            const pW = TS * 0.7;
            ...
            ctx.fillText(label, ox + TS / 2, pY - 4);
        ...
        // ── SPEED GATES ───────────────────────────────────────────────────────
            ...
            for (let ai = 0; ai < 3; ai++) {
                const xOff = ai * (TS * 0.22);
                ctx.globalAlpha = 1 - ai * 0.25;
                ctx.beginPath();
                ctx.moveTo(ox + 4 + xOff, oy - TS * 0.3);
                ctx.lineTo(ox + TS * 0.5 + xOff, oy + TS * 0.5);
                ctx.lineTo(ox + 4 + xOff, oy + TS * 1.3);
                ctx.stroke();
            }
            ctx.globalAlpha = 1;
            ...
            ctx.textAlign = 'center';
            ctx.fillText(speedLabel, ox + TS / 2, oy - TS * 0.6);
        ...
        // ── CYBER COIN ────────────────────────────────────────────────────────
            ...
            ctx.lineWidth = 2;
            ctx.globalAlpha = 0.5 + Math.sin(now * 3) * 0.3;
            ctx.beginPath();
            ctx.arc(0, 0, 20, 0, Math.PI * 2);
            ctx.stroke();
            ctx.globalAlpha = 1;
            const coinGrad = ctx.createRadialGradient(-4, -4, 2, 0, 0, 16);
            coinGrad.addColorStop(0, '#fff4a0');
        ...
        // ── PAD ICE ───────────────────────────────────────────────────────────
            ...
            const ibounce = Math.abs(Math.sin(now * 3)) * 2;
            ctx.shadowBlur = 18;
            ctx.shadowColor = '#00d4ff';
            const icePadGrad = ctx.createLinearGradient(ox, oy + TS - 10, ox, oy + TS);
            icePadGrad.addColorStop(0, '#60c8e8');
            icePadGrad.addColorStop(1, '#0088aa');
            ctx.fillStyle = icePadGrad;
            ctx.fillRect(ox + 3, oy + TS - 10, TS - 6, 10);
            ctx.fillStyle = 'rgba(200, 248, 255, 0.7)';
            ctx.fillRect(ox + 6, oy + TS - 9, TS - 12, 3);
            ctx.fillStyle = '#ffffff';
            ctx.globalAlpha = 0.9;
            ctx.beginPath();
            ctx.moveTo(ox + TS/2, oy + TS - 20 - ibounce);
            ctx.lineTo(ox + TS/2 - 6, oy + TS - 12);
            ctx.lineTo(ox + TS/2 + 6, oy + TS - 12);
            ctx.closePath();
            ctx.fill();
            ctx.globalAlpha = 1;
        ...
        // ── FREEZE ZONE ───────────────────────────────────────────────────────
            ...
            ctx.fillRect(ox, oy - TS * 2, TS, fzH);
            ctx.globalAlpha = 1;
        ...
        // ── ICE CRYSTAL (collectible) ─────────────────────────────────────────
            ...
            for (let h = 0; h < 6; h++) {
                ...
                const hx = Math.cos(ha) * 15;
                const hy = Math.sin(ha) * 15;
            ...
            for (let h = 0; h < 6; h++) {
                ...
                ctx.beginPath();
                ctx.moveTo(0, 0);
                ctx.lineTo(Math.cos(ha) * 15, Math.sin(ha) * 15);
                ctx.stroke();
            }
            ctx.fillStyle = '#ffffff';
            ctx.shadowBlur = 16;
        ...
        // ── BOOST PAD ────────────────────────────────────────────────────────
            ...
            const bFlash = Math.abs(Math.sin(now * 5));
            ctx.shadowBlur = 18;
            ctx.shadowColor = '#ff7700';
            ctx.fillStyle = `rgba(255, ${Math.floor(100 + bFlash * 80)}, 0, 1)`;
            ctx.fillRect(ox + 3, oy + TS - 10, TS - 6, 10);
            ctx.fillStyle = '#fff';
            ctx.globalAlpha = 0.8;
            ctx.beginPath();
            ctx.moveTo(ox + TS*0.35, oy + TS - 22);
            ctx.lineTo(ox + TS*0.5, oy + TS - 12);
            ctx.lineTo(ox + TS*0.65, oy + TS - 22);
            ctx.fill();
            ctx.globalAlpha = 1;

        // ── DASH RING ────────────────────────────────────────────────────────
        } else if (type === OBJECT_TYPES.DASH_RING) {
            const drPulse = Math.sin(now * 3) * 3;
            ctx.translate(ox + TS/2, oy + TS/2);
            ctx.rotate(now * 2);
            ctx.shadowBlur = 22;
            ...
            ctx.lineWidth = 3;
            ctx.beginPath(); ctx.arc(0, 0, 14 + drPulse, 0, Math.PI * 2); ctx.stroke();
            ctx.strokeStyle = '#ffffff';
            ctx.lineWidth = 1;
            ctx.beginPath(); ctx.arc(0, 0, 8 + drPulse * 0.5, 0, Math.PI * 2); ctx.stroke();
            ctx.fillStyle = '#00f0ff';
            ctx.beginPath();
            ctx.moveTo(-8, -4); ctx.lineTo(4, 0); ctx.lineTo(-8, 4);
