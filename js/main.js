/**
 * CYBER DASH // MAIN BOOTSTRAPPER & GAME ENGINE
 * Core loop, input routing, state machine, audio sync, and canvas rendering.
 */
...
export class CyberDashGame {
    constructor() {
        ...
        this.mode = 'MENU'; // 'MENU', 'PLAYING', 'PAUSED', 'EDITOR', 'EDITOR_PLAY'
    ...
    init() {
        ...
        // Apply saved garage configuration
    ...
    setupEditorPaletteUI() {
        ...
        // Editor Toolbar Action Bindings
    ...
    handleDeath() {
        ...
        // CRYO levels get ice shatter; normal levels get red explosion
